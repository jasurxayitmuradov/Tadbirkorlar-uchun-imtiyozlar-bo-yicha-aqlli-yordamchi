...
import { 
  ...
  GraduationCap, Database, Settings, ShieldCheck, Languages, ChevronDown, UserCircle, FileCheck
} from 'lucide-react';
...
const navItems = [
  ...
  { path: '/app/auto-benefits', labelKey: 'sidebar.auto.benefits', icon: FileCheck },
          ...
          <div className="p-4 border-t border-white/5">
            <div className="p-4 rounded-xl bg-slate-900 border border-white/5 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-semibold text-slate-200">{t('sidebar.official')}</p>
              </div>
            </div>
          </div>
        </div>
